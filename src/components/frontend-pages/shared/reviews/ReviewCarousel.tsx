...
const Reviews = [
  {
    ...
    name: "Jenny Wilson",
    text: "With Alpha Research, we don't just get data - we get directions",
  },
  {
    id: 2,
    img: "/images/profile/user-2.jpg",
    name: "Emily Carter",
    text: "Alpha Research has been go-to for fast reliable consumer insights",
  },
  {
    id: 3,
    img: "/images/profile/user-3.jpg",
    name: "James Mitchell",
    text: "They understand out market better than anyone - Alpha delivers every time",
  },
  {
    id: 4,
    img: "/images/profile/user-4.jpg",
    name: "Nathon Scott",
    text: "Thanks to Alpha Research, we make decisions backed by real consumber voices",
  },
  {
    id: 5,
    img: "/images/profile/user-5.jpg",
    name: "Olivia brooks",
    text: "Accurate, efficent, and always ahead - Alpha Research is a true partner",
  },
];
